...
std::vector<gol_menu> LoadGOLMenu()
{
	return
	std::vector<gol_menu>{
		{String("GOL"),		PIXPACK(0x0CAC00), 0, String("Game Of Life: Begin 3/Stay 23")},
		{String("HLIF"),	PIXPACK(0xFF0000), 1, String("High Life: B36/S23")},
		{String("ASIM"),	PIXPACK(0x0000FF), 2, String("Assimilation: B345/S4567")},
		{String("2x2"),		PIXPACK(0xFFFF00), 3, String("2x2: B36/S125")},
		{String("DANI"),	PIXPACK(0x00FFFF), 4, String("Day and Night: B3678/S34678")},
		{String("AMOE"),	PIXPACK(0xFF00FF), 5, String("Amoeba: B357/S1358")},
		{String("MOVE"),	PIXPACK(0xFFFFFF), 6, String("'Move' particles. Does not move things.. it is a life type: B368/S245")},
		{String("PGOL"),	PIXPACK(0xE05010), 7, String("Pseudo Life: B357/S238")},
		{String("DMOE"),	PIXPACK(0x500000), 8, String("Diamoeba: B35678/S5678")},
		{String("34"),		PIXPACK(0x500050), 9, String("34: B34/S34")},
		{String("LLIF"),	PIXPACK(0x505050), 10, String("Long Life: B345/S5")},
		{String("STAN"),	PIXPACK(0x5000FF), 11, String("Stains: B3678/S235678")},
		{String("SEED"),	PIXPACK(0xFBEC7D), 12, String("Seeds: B2/S")},
		{String("MAZE"),	PIXPACK(0xA8E4A0), 13, String("Maze: B3/S12345")},
		{String("COAG"),	PIXPACK(0x9ACD32), 14, String("Coagulations: B378/S235678")},
		{String("WALL"),	PIXPACK(0x0047AB), 15, String("Walled cities: B45678/S2345")},
		{String("GNAR"),	PIXPACK(0xE5B73B), 16, String("Gnarl: B1/S1")},
		{String("REPL"),	PIXPACK(0x259588), 17, String("Replicator: B1357/S1357")},
		{String("MYST"),	PIXPACK(0x0C3C00), 18, String("Mystery: B3458/S05678")},
		{String("LOTE"),	PIXPACK(0xFF0000), 19, String("Living on the Edge: B37/S3458/4")},
		{String("FRG2"),	PIXPACK(0x00FF00), 20, String("Like Frogs rule: B3/S124/3")},
		{String("STAR"),	PIXPACK(0x0000FF), 21, String("Like Star Wars rule: B278/S3456/6")},
		{String("FROG"),	PIXPACK(0x00AA00), 22, String("Frogs: B34/S12/3")},
		{String("BRAN"),	PIXPACK(0xCCCC00), 23, String("Brian 6: B246/S6/3")}
	};
}
